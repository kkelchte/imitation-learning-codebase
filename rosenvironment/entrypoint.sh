...
alias bebop_demo_full_red='export ROS_MASTER_URI=http://192.168.42.10:11311 && export ROS_HOSTNAME=192.168.42.10 && python3.8 src/sim/ros/src/online_evaluation_fgbg_real.py'
...
alias bebop_edge_red='export ROS_MASTER_URI=http://192.168.42.10:11311 && export ROS_HOSTNAME=192.168.42.72 && rosrun imitation_learning_ros_package robot_display_edge.py'
