...
# def prepare_dag_data_collection_train_evaluate() -> List[CondorJob]:
#     prepare_data_collection(base_config_file=self._config.base_config_files[0],
#                             job_config_object=self._config.job_configs[0],
#                             number_of_jobs=self._config.number_of_jobs[0])
#     prepare_default(base_config_file=self._config.base_config_files[1],
#                     job_config_object=self._config.job_configs[1],
#                     number_of_jobs=self._config.number_of_jobs[1])
#     prepare_train(base_config_file=self._config.base_config_files[2],
#                   job_config_object=self._config.job_configs[2],
#                   number_of_jobs=self._config.number_of_jobs[2])
#     prepare_evaluate_interactive(base_config_file=self._config.base_config_files[3],
