...
class CarRacing(gym.Env, EzPickle):
    ...
    def __init__(self, verbose=0, track_width=40/6.):
    ...
    def render_road(self):
        ...
        gl.glColor4f(0.4, 0.8, 0.4, 1.0) # background green
        gl.glVertex3f(-PLAYFIELD, +PLAYFIELD, 0)
        gl.glVertex3f(+PLAYFIELD, +PLAYFIELD, 0)
        gl.glVertex3f(+PLAYFIELD, -PLAYFIELD, 0)
        gl.glVertex3f(-PLAYFIELD, -PLAYFIELD, 0)
        gl.glColor4f(0.4, 0.9, 0.4, 1.0) # background lighter green
