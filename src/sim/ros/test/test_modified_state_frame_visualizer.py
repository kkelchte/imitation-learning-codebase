...
from src.sim.ros.src.utils import euler_from_quaternion, process_float32multi_array
...
class TestModifiedStatePublisher(unittest.TestCase):
    ...
    def test_modified_state_frame_visualizer(self):
        ...
        frame = process_float32multi_array(self.ros_topic['/modified_state_frame'])
        plt.imshow(frame)
        plt.show()
        a = 100
